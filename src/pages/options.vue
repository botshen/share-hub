      ...
      <div class="comments-container">
        ...
        <div class="selected-zone" 
          ...
          <div class="selected-zone-header flex items-center justify-between">
            ...
            <span class="text-sm text-gray-500">拖动评论到此处添加到精选</span>
          </div>
          <VueDraggable 
          ...
          <template #item="{ element }">
            <div class="comment-item" 
              ...
              <x-comment id="comment" class="px-2 block">
                ...
                <div class="break-words whitespace-pre-wrap overflow-wrap-anywhere ml-10 mt-1" v-html="element.content" />
              </x-comment>
            </div>
          </template>
        </VueDraggable>
...
.selected-comment:hover, .comment-item:hover {
  box-shadow: 0 8px 16px rgba(0,0,0,0.1);
  transform: translateY(-2px) rotate(1deg);
}

.selected-comment:active, .comment-item:active {
  cursor: grabbing;
}
